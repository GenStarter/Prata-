...
std::cout<<"Please enter your height in feet and inches:___\b\b\b ";
int feet;
int rem_inch;
std::cin>>feet>>rem_inch;
std::cout<<"Please enter your weight in pounds:___\b\b\b ";
int weight;
std::cin>>weight;
std::cout<<" Your BMI is "<<(weight/2.2)/pow(((feet*12 + rem_inch)*0.0254),2);
